...
public class LoginV3Panel extends JPanel {

	private static final long serialVersionUID = 1L;

	public interface LoginV3Callback {
        void doLogin(String authUrl, String tenant, String domain, String authScope, String username, char[] pass);
    }
    ...
    private String[] authScopeOptions = { "default" , "domain", "project", "none" };
    private JComboBox authScope = new JComboBox(authScopeOptions);
    private JLabel warningLabel = null ;

    private LoginV3Callback callback;
    ...
    public LoginV3Panel(LoginV3Callback callback, CredentialsStore credentialsStore, HasLocalizedStrings stringsBundle) {
        ...
        box.add(new LabelComponentPanel("Domain", domain));
        box.add(new LabelComponentPanel("Auth Scope", authScope));
    ...
    {
        okAction = new ReflectionAction<LoginV3Panel>(getLocalizedString("Ok"), MainPanel.getIcon("server_connect.png"), this, "onOk");
        saveAction = new ReflectionAction<LoginV3Panel>("", MainPanel.getIcon("table_save.png"), this, "onSave");
        deleteAction = new ReflectionAction<LoginV3Panel>("", MainPanel.getIcon("table_delete.png"), this, "onDelete");
        cancelAction = new ReflectionAction<LoginV3Panel>(getLocalizedString("Cancel"), this, "onCancel");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedIndex <= 0) {
                    ...
                    if (cr != null) {
                        ...
                        domain.setText(cr.domain);
                        authScope.setSelectedItem(cr.authScope);
    ...
    private void bindDocumentListeners() {
        ...
        domain.getDocument().addDocumentListener(lst);
    ...
    public void onOk() {
        callback.doLogin(authUrl.getText().trim(), tenant.getText().trim(), domain.getText().trim(), String.valueOf(authScope.getSelectedItem()), username.getText().trim(), password.getPassword());
    }
    ...
    public void onSave() {
        ...
        cr.domain = domain.getText().trim();
        cr.authScope = String.valueOf(authScope.getSelectedItem());
