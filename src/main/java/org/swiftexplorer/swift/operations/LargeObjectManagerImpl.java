...
class LargeObjectManagerImpl implements LargeObjectManager {

    final Logger logger = LoggerFactory.getLogger(LargeObjectManagerImpl.class);
	...
	LargeObjectManagerImpl (Account account) { 
		super () ; 
